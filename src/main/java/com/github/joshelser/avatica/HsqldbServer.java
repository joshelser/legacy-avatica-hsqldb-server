 ...
 */
package com.github.joshelser.avatica;
...
/**
 * An Avatica server for HSQLDB. Port for Calcite-1.6
 */
  ...
  public void start() {
    ...
    try {
      ...
      case PROTOBUF:
        ...
        break;
      default:
        System.exit(ExitCodes.UNKNOWN_SERIALIZATION.ordinal());
        return;
      }

      // Construct the server
      this.server = new HttpServer(port, handler);
